...
| [sceneTranslateAuto](./sceneTranslateAuto/) | 1.2.0 | 纯后台 | 钩子自动翻译场景标题/简介为目标语言 + 任务页全量扫描（复用 sceneTranslate 引擎，无代理无端口） |
| [javstashAutofill+](./javstashAutofill+/) | 1.0.8 | 纯后台 | 新演员按名刮削 JAVStash 补全字段+stash_id；新场景按 oshash 补空白字段+stash_id；手动任务批量回填 |
